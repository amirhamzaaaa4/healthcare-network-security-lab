...
This ledger prevents design intentions from being presented as completed work. Change an item to **Verified** only after rebuilding it and adding genuine, sanitised evidence.
...
| Guest internet-only isolation | Proposed | Negative internal tests and positive external test |
| Secure management controls | Proposed | Sanitised configuration and management-path test |
| SIEM, MFA, site-to-site VPN | Future extension | Separate implementation and evidence |

## Evidence log

| Date | Test | Expected | Observed | Result | Evidence path |
|---|---|---|---|---|---|
| YYYY-MM-DD | Example: Guest to clinical ping | Denied | Not yet run | Pending | — |
